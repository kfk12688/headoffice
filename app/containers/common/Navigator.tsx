...
import { Row, Col, TabGroup, Tab, NavLink } from "../../components/index";
...
const Navigator: React.StatelessComponent<IProps> = (props: IProps) => {
  return (
    <Row
      fullWidth
      className={ cx("ho-nav-container", { "rolled-up" : props.rollUp })}
    >
      <Row className="row">
        <Col size={5}>
