        ...
        <div className={styles.filterHeaderBlock}>
          ...
          <div className={styles.filterHeaderBlock}>
            <div>
              ...
              {(owner !== undefined) && <ClearSpan h={changeHandlers.setOwner}/>}
            </div>
            <PopupSearchBox
              value={owner}
          ...
          <div className={styles.filterHeaderBlock}>
            <div>
              ...
              {(dateModifiedStart !== undefined) && dateModifiedStart.isValid() && <ClearSpan h={changeHandlers.setDateModifiedStart}/>}
            </div>
            <PopupDateBox
          ...
          <div className={styles.filterHeaderBlock}>
            <div>
              ...
              {(dateModifiedEnd !== undefined) && dateModifiedEnd.isValid() && <ClearSpan h={changeHandlers.setDateModifiedEnd}/>}
            </div>
            <PopupDateBox
