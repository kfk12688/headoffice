...
export const TEMPLATE_EDIT_ROW = "TEMPLATE_EDIT_ROW";
export const TEMPLATE_DELETE_ROW = "TEMPLATE_DELETE_ROW";
export const TEMPLATE_DUPLICATE_ERROR = "TEMPLATE_DUPLICATE_ERROR";
